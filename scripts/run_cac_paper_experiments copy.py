...
def experiment_matrix(args):
    ...
    return [
        ...
        },
        {
            ...
            "stage_resampling": False,
            "deploy_only": True,
            "notes": "固定 temporal ensemble 系数 0.01，接近原始 ACT 推荐的轻量平滑。",
        },
        {
            "id": "CATE_E6_fixed_005",
            "suite": "cate",
            "phase_default": "deploy",
            "dataset_root": DEFAULT_BASELINE_DATASET,
            "ckpt_dir": cate_ckpt,
            ...
            "stage_resampling": False,
            "deploy_only": True,
            "notes": "固定 temporal ensemble 系数 0.05，用于观察轻平滑到中等平滑的过渡。",
        },
        {
            "id": "CATE_E7_fixed_010",
            "suite": "cate",
            "phase_default": "deploy",
            "dataset_root": DEFAULT_BASELINE_DATASET,
            "ckpt_dir": cate_ckpt,
            "temporal_ensemble_coeff": "0.10",
            "adaptive_te": False,
            "stage_resampling": False,
            "deploy_only": True,
            "notes": "固定 temporal ensemble 系数 0.10，中低强度平滑对照。",
        },
        {
            "id": "CATE_E9_fixed_015",
            "suite": "cate",
            "phase_default": "deploy",
            "dataset_root": DEFAULT_BASELINE_DATASET,
            "ckpt_dir": cate_ckpt,
            "temporal_ensemble_coeff": "0.15",
            "adaptive_te": False,
            "stage_resampling": False,
            "deploy_only": True,
            "notes": "固定 temporal ensemble 系数 0.15，用于细化 0.10 到 0.30 之间的平滑强度。",
        },
        {
            "id": "CATE_E10_fixed_020",
            "suite": "cate",
            "phase_default": "deploy",
            "dataset_root": DEFAULT_BASELINE_DATASET,
            "ckpt_dir": cate_ckpt,
            "temporal_ensemble_coeff": "0.20",
            "adaptive_te": False,
            "stage_resampling": False,
            "deploy_only": True,
            "notes": "固定 temporal ensemble 系数 0.20，用于细化 0.10 到 0.30 之间的平滑强度。",
        },
        {
            "id": "CATE_E8_fixed_030",
            "suite": "cate",
            "phase_default": "deploy",
            "dataset_root": DEFAULT_BASELINE_DATASET,
            "ckpt_dir": cate_ckpt,
            "temporal_ensemble_coeff": "0.30",
            "adaptive_te": False,
            "stage_resampling": False,
            "deploy_only": True,
            "notes": "固定 temporal ensemble 系数 0.30，低系数 sweep 的上界；保留 E1b 旧命名以兼容历史结果。",
        },
        {
